					...
					<Row id='about-body' className='justify-content-lg-center'>
						...
						<Col id='text-container'>
							<p id='about-text'>
								...
								in Summer 2021 and am seeking a Software
								Engineering internship. By obtaining an
								internship, I hope to gain the experience and
								knowledge necessary to provide optimal results
								at the company I work for in my career. I am a
								very diligent and detail-oriented individual
								that always strives to stay on the cutting-edge
								of technology. I hope to bring these qualities
								to an internship.
								<br />
								<br />
